  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        action: ["h1 {", "  color: #225668;", "  font-size: 30px;", "}"],
        render: true,
      },
      {
        type: "dom",
        desc: "Paragraphs are used to block out text used to provide information to your users.",
        action: ["<p>I have something to share with you.</p>"],
        render: true,
      },
      {
        type: "style",
        desc: "Now let's all paragraph tags",
        action: ["p {", "  font-size: 12px;", "  color: #3fcc6e;", "}"],
        render: true,
      },
      {
        type: "dom",
      ...
      },
      {
        ...
        action: ["#different {", "  color: #c41bb0;", "  font-size: 20px;", "}"],
        render: true,
      },
      {
        type: "dom",
      ...
      },
      {
        ...
        action: ["a {", "  color: #b2972a;", "  text-decoration: none;", "}"],
        render: true,
      },
      {
        type: "dom",
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        type: "style",
        desc: "Now let's all anchor tags",
        action: ["a {", "  color: #0ff1ce;", "  text-decoration: none;", "}"],
        render: true,
      },
      {
        type: "dom",
      ...
      },
      {
        ...
        action: ["img {", "  width: 250px;", "  height: 250px;", "}"],
        render: true,
      },
      {
        type: "dom",
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        action: ["p{ color: #11ccdd; font-size: 25px; font-weight: bold; }"],
        render: true,
      },
      {
        type: "style",
        desc: "You can select elements inside of another element like so",
        action: ["p a{ color: #ff00aa; text-decoration: none; }"],
        render: true,
      },
      {
        type: "dom",
      ...
      },
      {
        type: "style",
        desc: "You can change the size and color of the paragraph by using the font-size and color properties.",
        action: [".fancy {", "  color: #11ccdd;", "  font-family: cursive;", "}"],
        render: true,
      },
      {
        type: "dom",
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        action: [".item-container {", "  width: 500px;", "  height: 500px;", "  border: 1px solid black;", "}"],
        render: true,
      },
      {
        type: "style",
        desc: "Let's give our items some size and color! Start with item1.",
        action: [".item1 {", "  background-color: red;", "  width: 100px;", "  height: 100px;", "}"],
        render: true,
      },
      {
        type: "style",
        desc: "Great! Now style item2.",
        action: [".item2 {", "  background-color: blue;", "  width: 100px;", "  height: 100px;", "}"],
        render: true,
      },
      {
        type: "style",
        ...
        action: [".item-container {", "  display: flex;", "}"],
        render: true,
      },
      {
        type: "style",
        ...
        action: [".item-container {", "  justify-content: center;", "}"],
        render: true,
      },
      {
        type: "style",
        ...
        action: [".item-container {", "  align-items: center;", "}"],
        render: true,
      },
      {
        type: "style",
        ...
        action: [".item-container {", "  justify-content: space-evenly;", "}"],
        render: true,
      },
      {
        type: "style",
